...
class App extends Component {
    ...
    try {
      ...
      if (response.cod === '200') {
        ...
        this.setState({
          error: `!Error: ${
            response.message
          }, please check location inputs again`,
          incorrctCountryNameError: undefined,
          cityInput: undefined,
          countryInput: undefined,
          city: undefined,
  ...
  componentDidUpdate(prevProps, prevState) {
    console.log(
      ...
      this.state.incorrctCountryNameError,
    ...
    if (
      (this.state.cityInput !== prevState.cityInput ||
        this.state.countryInput !== prevState.countryInput) &&
      this.state.countryInput !== undefined
    ) {
